...
export const URL_PATTERNS = {
  ...
  product: [
    ...
    /\/p\/[^/]+/i,
    // `<slug>/p` — термінальний маркер картки у VTEX IO. 🔴 Звужено після
    // ревʼю Б.3: перед `/p` вимагається багатослівний (дефісний) слаг, інакше
    // патерн зʼїдав службові `/help/p`, `/shop/p`. Односегментний слаг
    // (`/ravioli/p`) свідомо не ловиться — його добирають fanout-leaf і якорі.
    /\/[\w-]+-[\w-]+\/p$/i,
