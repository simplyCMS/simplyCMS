...
//
// 🔴 Це ЧАСТИНА рішення B12, а не його завершення. Дуальна система типів
// (`supabase/types.ts` — генерат магазину; `src/supabase/database.ts` —
// baseline ядра) СЬОГОДНІ ЖИВА і заморожена до контуру К1′б: доки в коді
