 ...
 * розширення.
 *
 * 🔴 Експортована ЧИСТА функція, а не інлайн-шаблон усередині `put`, саме
 * заради гейта: інакше тест звіряв би регекс із рядком, який написав сам
 * (тавтологія — жодна мутація драйвера його не червонить; спіймано рев'ю Е2).
 */
export function mediaTmpName(): string {
