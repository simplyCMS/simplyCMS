 ...
 * з `FANOUT_MIN_CHILDREN`, а не дублює його літералом: там та сама межа з
 * іншого боку («≥3 дітей — уже індекс колекції»). Два незалежні `3`
 * розійшлися б при першій правці одного з них.
 */
