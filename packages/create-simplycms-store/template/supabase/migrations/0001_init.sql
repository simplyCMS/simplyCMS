...
COMMENT ON COLUMN "products"."id" IS 'Категорія A: client-generated UUID. DEFAULT знято навмисно — fail-loud guard проти розсинхрону оптимістичного й серверного ключа.';--> statement-breakpoint
