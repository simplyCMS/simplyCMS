...
> добу тому (захист від supply-chain-атак). Або зачекай добу після виходу
> нової версії `@simplycms/*`, або одноразово
> `pnpm install --minimum-release-age=0`, свідомо приймаючи ризик.
