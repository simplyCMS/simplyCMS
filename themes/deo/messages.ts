 ...
 *
 * 🔴 `theme.brand` — назва НАШОГО магазину, а не референсу. Референс
 * називається «Deo», і саме тому ця назва тут НЕ стоїть: ключ теми `deo`
 * — внутрішній ідентифікатор походження, а бренд на вітрині бачить
 * покупець, і чужий бренд там — це імперсонація (правові межі фази 0).
