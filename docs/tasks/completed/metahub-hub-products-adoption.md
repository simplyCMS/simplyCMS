...
> **[АРХІВ 2026-07-30]** ЗАКРИТО 2026-07-30 (скасовано власником): MetaHub реалізує домен «Продукти» власним шляхом, adoption пакетів SimplyCMS не відбудеться. Концепція модульного ядра ЛИШАЄТЬСЯ стратегією SimplyCMS — розвивається в межах архітектури платформи (див. design doc у docs/superpowers/specs/ після затвердження).
