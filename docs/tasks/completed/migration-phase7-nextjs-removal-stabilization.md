...
> **[АРХІВ 2026-07-30]** Виконано у 2026-06: Next.js повністю видалено з runtime; документація приведена у відповідність 2026-07-30. Чекбокси історично не відмічались.

> Execution note: ця фаза не повинна заміняти собою попередні фази. Якщо під час її запуску Next.js ще залишається частиною runtime, це дефект ранніх фаз, який треба добити тут як residual cleanup.
> Це кодова й verification-фаза одночасно: cleanup, документація, grep-based перевірки, build/lint/typecheck і фінальна функціональна валідація.
> Не переглядати фазу як місце для нових архітектурних рішень, окрім усунення залишкових суперечностей.
