...
PR #32; прогалини процесу — скоуп цього інкремента. Артефакти інспекцій (`docs/design-references/`) з
...
- [x] **Тема лайв-тесту стала default-темою** — виконано 2026-08-17 ще в
      ...
      автоматично).
- [ ] **Фінальна валідація = повторний прогін механізму проти того самого
      референсу**: шліфування default-теми до професійного рівня.
