...
- [ ] Виконання — трек C завершено 2026-08-18 (Б.1–Б.3), черга A настала.
      Задача: [`theme-views-v3.md`](./theme-views-v3.md); план (8 фаз,
      рішення Р1–Р12):
      [`2026-08-18-theme-views-v3.md`](../superpowers/plans/2026-08-18-theme-views-v3.md);
      базова гілка — `claude/theme-views-v3`. Після мержу — жива
      валідація: прогін №4 механізму клонування (фаза «Шліфування»
      отримує щабель «view теми» → клон лейауту картки/каталогу в
      default-тему).
