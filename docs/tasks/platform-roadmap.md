...
- [x] **Виконано 2026-08-18** (гілка `claude/theme-views-v3`).
      ...
      🔴 Незакритий борг: **жива валідація** — прогін №4 механізму
      клонування (фаза «Шліфування» тепер має щабель «view теми» → клон
      лейауту картки/каталогу в default-тему) і піксельний side-by-side
      канонічних сторінок після спліту; обидва потребують стенду.
