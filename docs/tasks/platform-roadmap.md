...
4. ~~**i18n-міграція**~~ — **закрито 2026-08-09**. Мігровано обидва пакети:
   ...
   Каталог: 956 ключів у 31 модулі, `uk` і `en` дзеркальні файл у файл.
   ...
   Незакрите: **візуальної перевірки не було** (у сесії немає браузера) —
   список місць під очі в PR i18n-міграції.
