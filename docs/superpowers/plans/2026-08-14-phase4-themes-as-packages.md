...
- [x] **Step 1:** Новий `docs/architecture/themes.md` за структурою
...
- [x] **Step 2:** Синхронізація канону — конкретні якорі: `CLAUDE.md`
...
- [x] **Step 3:** Амендменти спеки §5/§6 (Р14) — за прецедентом §4.0.
- [x] **Step 4:** `CHANGELOG.md` Unreleased — блок Фази 4 з 🔴-попередженням
      про публікацію нового пакета в момент мержу (Р12) + виправлення «22».
- [x] **Step 5:** Роадмап: відмітити виконане у Фазі 4, оновити «Поточний
      стан», лічильники і борги (живий DoD-прогін + e2e-селектор theme.e2e —
      власник).
- [x] **Step 6:** Фінальний повний прогін гейтів у канонічному порядку +
      `pnpm pilot:pack`.
