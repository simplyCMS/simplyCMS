...
- [x] **Step 1:** `SKILL.md` фаза 5 — обовʼязковий side-by-side по
      ...
      користувачем на фазі 1.2, і `cart`/`checkout` без змоги наповнити
      кошик: обидва рядком у таблиці, скріншот кошика під іменем
      `checkout` — заборонений прямим текстом).
