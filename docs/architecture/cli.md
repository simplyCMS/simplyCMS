...
🔴 Єдиний виняток — **`create` (theme/plugin)**: він працює ще й у корені
**монорепо ядра**, бо авторський скаффолд теми/плагіна потрібен і там.
...
`findScaffoldRoot` (лише `create`) — ще й монорепо-маркер. Розширювати виняток
