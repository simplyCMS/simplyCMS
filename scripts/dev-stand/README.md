...
літералом, тому арбітр стабільний між прогонами. За `id` іде й дедуп рядків
у генераторі: дві глобальні властивості з одним слагом схема ДОЗВОЛЯЄ, і
викидати другу мовчки (разом із валідністю FK у її дітей) генератор не має
права — природний ключ лишається тільки ключем сортування.
