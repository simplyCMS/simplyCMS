 ...
 * link` + `db push`) і потім перегенеровував типи БД. Обидві половини вмерли
 * разом зі стеком:
 *
 ...
 * (роадмап платформи), разом із текою `supabase/`. Генератор типів
 * (`db:generate-types`/`types:baseline`) уже знесено в 0.4.1.
 */
