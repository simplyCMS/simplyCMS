...
export const PENDING_FILES: readonly string[] = [
  ...
  'packages/admin/src/hooks/usePluginToggle.ts',
  'packages/admin/src/layouts/AdminLayout.tsx',
  'packages/admin/src/layouts/AdminSidebar.tsx',
  'packages/admin/src/lib/revalidateTheme.ts',
  ...
  'packages/admin/src/pages/PlaceholderPage.tsx',
  ...
  'packages/storefront-routes/src/components/ProductCarousel.tsx',
  'packages/storefront-routes/src/pages/Auth.tsx',
  'packages/storefront-routes/src/pages/Catalog.tsx',
  'packages/storefront-routes/src/pages/CatalogSection.tsx',
  'packages/storefront-routes/src/pages/Checkout.tsx',
  'packages/storefront-routes/src/pages/Home.tsx',
  'packages/storefront-routes/src/pages/OrderSuccess.tsx',
  'packages/storefront-routes/src/pages/ProductDetail.tsx',
  'packages/storefront-routes/src/pages/Profile.tsx',
  'packages/storefront-routes/src/pages/ProfileOrderDetail.tsx',
  'packages/storefront-routes/src/pages/ProfileOrders.tsx',
  'packages/storefront-routes/src/pages/ProfileSettings.tsx',
  'packages/storefront-routes/src/pages/Properties.tsx',
  'packages/storefront-routes/src/pages/PropertyDetail.tsx',
  'packages/storefront-routes/src/pages/PropertyPage.tsx',
  'packages/storefront-routes/src/server/revalidate-theme.ts',
];
