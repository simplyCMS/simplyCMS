...
// Гард детерміністичного сіду пілота.
//
// 🔴 Споживача (`pnpm pilot:e2e`, Gate B у режимі `--e2e` асертив КОНКРЕТНІ
// назви товарів) знесено разом зі стеком Supabase у 0.4.1 — фікстури
// лишаються під парність-тестом до треку К6. Тому `supabase/seed.sql`
// ГЕНЕРУЄТЬСЯ з фікстур, а цей тест стереже, що закомічений файл не
// розійшовся з генератором.
